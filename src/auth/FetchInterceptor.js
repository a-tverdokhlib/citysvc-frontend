...
service.interceptors.response.use((response) => {
    ...
    else if ((error.response.status === 400 || error.response.status === 401) && (window.location.pathname === "/auth/register" || window.location.pathname === "/auth/login" || window.location.pathname === "/auth/verify-email/" || window.location.pathname === "/auth/verify-email"
